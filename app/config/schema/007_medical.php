...
return array(
    ...
    'migrations' => array(
        ...
        // v10：会诊病历关联——patient_records 增加 consultation_id，
        // B 科室医生为会诊新开的病历（progress）关联到 consultations.id
        10 => array(
            "ALTER TABLE patient_records ADD COLUMN consultation_id INTEGER DEFAULT 0",
        ),
    ),
    'seed' => array(),
);
