...
<div class="card list-filter">
    <div class="flex gap-8" style="align-items:center;flex-wrap:wrap">
        <input type="text" class="input input-date" id="anaStart" readonly placeholder="开始日期"  onclick="Clinic.datePicker.open(this, { maxToday: false, peer: 'anaEnd', maxSpan: 366, onChange: function () { anaLoad(); } })">
        <span class="text-muted">至</span>
        <input type="text" class="input input-date" id="anaEnd" readonly placeholder="结束日期"  onclick="Clinic.datePicker.open(this, { maxToday: true, peer: 'anaStart', maxSpan: 366, onChange: function () { anaLoad(); } })">
