        ...
        array(
            ...
            'fields' => array(
                array('key' => 'his_system_code', 'label' => '系统代码', 'type' => 'input',
                    'placeholder' => '本系统在 HIS 侧登记的系统编码', 'default' => '', 'source' => 'org_code',
                    'hint' => '自动引用系统医疗机构代码（org_code），无需人工输入；认证仅依赖密钥，配置后会在 ping 自检返回值中回显。'),
        ...
        array(
            ...
            'fields' => array(
                ...
                array('key' => 'yibao_org_code', 'label' => '机构编码', 'type' => 'input',
                    'placeholder' => '医保中心分配的定点机构编码', 'default' => '', 'monospace' => true, 'source' => 'org_code',
                    'hint' => '自动引用系统医疗机构代码（org_code），无需人工输入；医保接口为预留配置，接入时以此编码作为机构唯一标识上报。'),
