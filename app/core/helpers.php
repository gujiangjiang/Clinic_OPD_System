...
function send_msg($toRole, $toUserId, $title, $content = '', $printType = '', $printUrl = '', $extra = array()) {
    ...
    DB::insert('core', 'INSERT INTO messages(from_name, to_role, to_user_id, title, content, print_type, print_url, is_read, msg_type, patient_name, visit_id, link_url, created_at) VALUES(?,?,?,?,?,?,?,0,?,?,?,?,?)', array(
