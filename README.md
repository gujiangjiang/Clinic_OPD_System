...
![版本](https://img.shields.io/badge/版本-v7.26.0-blue) ![PHP](https://img.shields.io/badge/PHP-7.x-777BB4) ![数据库](https://img.shields.io/badge/数据库-SQLite%2FMySQL双驱动-003B57) ![部署](https://img.shields.io/badge/部署-Nginx-009639) ![代码](https://img.shields.io/badge/代码-全中文注释-orange)
...
| 🩻 影像科 | **工作台布局**（候诊列表「检查中/完成/当日」，申请单号可展开项目）：点击候诊患者弹出影像诊断报告单页（急诊病历式抬头），整张申请单统一登记；「✍️ 去写报告」模态框书写影像所见 / 影像诊断（支持影像报告模板覆盖 / 续写），提交生成 **A4 检查报告单**（标题按检查分类动态化如 CT / DR、所见 2/3 + 诊断 1/3）；申请撤回；检查项目管理（只读，新增走审核） |
