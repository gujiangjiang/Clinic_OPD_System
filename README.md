...
![版本](https://img.shields.io/badge/版本-v8.16.1-blue) ![PHP](https://img.shields.io/badge/PHP-7.x-777BB4) ![数据库](https://img.shields.io/badge/数据库-SQLite%2FMySQL双驱动-003B57) ![部署](https://img.shields.io/badge/部署-Nginx-009639) ![代码](https://img.shields.io/badge/代码-全中文注释-orange)
...
│   │   └── schema/            # 数据库表结构定义
│   │       ├── main.php       # 统一业务主库 schema（42 张表，SQLite/MySQL 双驱动兼容）
