...
![版本](https://img.shields.io/badge/版本-v1.6.19-blue) ![PHP](https://img.shields.io/badge/PHP-7.x-777BB4) ![数据库](https://img.shields.io/badge/数据库-SQLite%2F预留MySQL-003B57) ![部署](https://img.shields.io/badge/部署-Nginx-009639) ![代码](https://img.shields.io/badge/代码-全中文注释-orange)
...
| 模块 | 功能 |
| --- | --- |
| 🎫 挂号收费处 | 身份证 18 位校验、自动计算并锁定出生日期/性别（年龄按出生日期自动计算）、既往登记自动填充、姓名/性别/出生日期必填（出生日期日历组件选择）、通用科室选择弹窗（急诊/门诊分 Tab，实时显示剩余号源与挂号费）、今日号源静态总览、挂号缴费、凭条打印、挂号管理（按天查询/补打/患者信息修改）、缴费退费管理 |
